...
export const DARIO_CONTACT: DRContactData = {
  id: 'dario',
  company: 'D.R SA',
...
export const MARIANO_CONTACT: DRContactData = {
  id: 'mariano',
  company: 'D.R SA',
  qrHeadline: 'D.R SA QR',
  qrSubtext: 'ESCANEÁ PARA CONOCERNOS',
...
export const CONTACTS_MAP: Record<string, DRContactData> = {
  dario: DARIO_CONTACT,
  mariano: MARIANO_CONTACT,
};

export const DEFAULT_CONTACT_DATA = DARIO_CONTACT;
